...
export const SIGNS = Object.freeze({
	HELLO: {
		...
		phases: [
			{ face: 'pleasant', t: 0.3, right: { shape: 'FLAT', at: { anchor: 'forehead', out: 0.2, up: -0.2, forward: 0.16 }, fingers: ['up', 'in'], palm: ['forward', 'down'] }, head: { nod: 2 }, hold: 0.1 },
			{ face: 'pleasant', t: 0.32, right: { shape: 'FLAT', at: { anchor: 'forehead', out: 0.34, up: -0.22, forward: 0.2 }, fingers: ['up', 'out'], palm: 'forward' }, head: { nod: -2 }, hold: 0.18 },
		],
	},
	THANK: {
	...
	PLEASE: {
		...
		phases: [
			{ t: 0.3, right: { shape: 'FLAT', at: { anchor: 'sternum', out: 0.02, up: -0.15, forward: 0.16 }, fingers: ['up', 'in'], palm: 'back' } },
			{ t: 0.26, right: { shape: 'FLAT', at: { anchor: 'sternum', out: 0.09, up: -0.2, forward: 0.16 }, fingers: ['up', 'in'], palm: 'back' } },
			{ t: 0.26, right: { shape: 'FLAT', at: { anchor: 'sternum', out: 0.02, up: -0.25, forward: 0.16 }, fingers: ['up', 'in'], palm: 'back' } },
			{ t: 0.26, right: { shape: 'FLAT', at: { anchor: 'sternum', out: -0.04, up: -0.2, forward: 0.16 }, fingers: ['up', 'in'], palm: 'back' } },
			{ t: 0.26, right: { shape: 'FLAT', at: { anchor: 'sternum', out: 0.02, up: -0.15, forward: 0.16 }, fingers: ['up', 'in'], palm: 'back' }, hold: 0.1 },
		],
	},
	SORRY: {
